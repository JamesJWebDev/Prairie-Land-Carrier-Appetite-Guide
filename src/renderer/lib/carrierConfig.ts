 ...
 * Base weights reflect agency positioning; eligibility/weight logic lives in suggestions.ts.
 */
...
export interface CarrierConfig {
  auto: CarrierEntry[]
  home: CarrierEntry[]
  commercial: CarrierEntry[]
}

export const CARRIER_CONFIG: CarrierConfig = {
  auto: [
