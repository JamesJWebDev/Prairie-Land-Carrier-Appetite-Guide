...
/** @typedef {{ when: (inputs: any, ctx?: any) => boolean, reason?: string, reasonByCarrier?: Record<string, string>, ineligible?: boolean, weight?: number, carriers?: string | string[] }} Rule */

function appliesTo(carrierKey, rule) {
...
function applyRule(rule, inputs, carrier, state, ctx = {}) {
...
function applyRules(rules, inputs, carrier, state, ctx = {}) {
...
const SHARED_WEIGHT_RULES = [
  {
    when: (i) => i.claimsHistory === 'none',
    weight: 0.4,
    reason: 'No recent claims â€“ preferred markets favored.',
  },
  {
    when: (i) => i.claimsHistory === 'one',
    reason: 'One claim â€“ most markets still open.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
    weight: -0.4,
    reason: 'Multiple claims â€“ tilt away from strict preferred markets.',
  },
  {
    when: (i) => Number(i.priorCarrierYears || 0) === 0,
    weight: -0.3,
    reason: 'No continuous insurance â€“ some carriers less competitive.',
  },
  {
    when: (i) => Number(i.priorCarrierYears || 0) >= 3,
    weight: 0.3,
    reason: '3+ years continuous insurance â€“ stability credit.',
  },
  {
    when: (i) => i.multiPolicy === 'yes',
    weight: 0.3,
    reason: 'Bundling opportunity â€“ favor package-friendly carriers.',
  },
];
...
const AUTO_INELIGIBILITY_RULES = [
  {
  ...
  },
  {
    ...
    ineligible: true,
    reason:
      'Applicant or a listed driver was previously declined, nonrenewed, or cancelled by Progressive for underwriting reasons â€“ not acceptable per Progressive guidelines.',
  },
  {
    when: (i) => i.atFaultAccidents === '2plus',
    carriers: ['erieAuto'],
    ineligible: true,
    reason: 'More than one at-fault accident in recent years â€“ outside standard Erie auto guidelines.',
  },
  {
    when: (i) => i.autoCompLosses === '4plus',
    carriers: ['erieAuto'],
    ineligible: true,
    reason: 'Four or more comprehensive losses in 5 years â€“ outside typical Erie auto guidelines.',
  },
  {
    when: (i) => i.movingViolations === 'many_or_major',
    carriers: ['erieAuto'],
    ineligible: true,
    reason: 'Multiple / major moving violations â€“ exceeds Erie auto violation thresholds.',
  },
  {
    ...
    ineligible: true,
    reason:
      'Modified / nonâ€‘roadworthy / rebuildâ€‘inâ€‘progress vehicles are ineligible for Erie private passenger auto.',
  },
  {
    when: (i) => i.vehicleType === 'modified_or_not_roadworthy',
...
const AUTO_WEIGHT_RULES = [
  {
    when: (i) => i.continuousAuto === 'no',
    carriers: ['progressiveAuto'],
    weight: 0.2,
    reason:
      'No prior or lapse â€“ Progressive may still accept; up to 31 days lapse counts as prior. Prior insurance discount may not apply.',
  },
  {
    when: (i) => i.atFaultAccidents === '1',
    carriers: ['erieAuto'],
    reason: 'One at-fault accident â€“ may be acceptable for Erie if otherwise clean; watch other negatives.',
  },
  {
    when: (i) => i.atFaultAccidents === '2plus',
    carriers: ['progressiveAuto'],
    weight: 0.2,
    reason: 'Multiple at-fault accidents â€“ Progressive may still consider nonâ€‘standard auto.',
  },
  {
    when: (i) => i.movingViolations === 'few_minor',
    reason: 'Some minor violations â€“ most markets still in play.',
  },
  {
    when: (i) => i.movingViolations === 'many_or_major',
    carriers: ['progressiveAuto'],
    weight: 0.2,
    reason:
      'Multiple / major violations â€“ Progressive rates on violations (35/59 mo) rather than hard-declining; expect surcharges.',
  },
  {
    when: (i) => i.annualMileage === '>25000',
    carriers: ['erieAuto'],
    weight: -0.3,
    reason: 'Very high annual mileage â€“ Erie guidelines flag >25,000 miles as a concern.',
  },
  {
    when: (i) => i.vehicleUse === 'tnc',
    carriers: ['progressiveAuto'],
    reason:
      'Rideshare/delivery â€“ Progressive allows with Rideshare Insurance endorsement; ensure proper TNC coverage.',
  },
  {
    when: (i) => i.vehicleUse === 'business',
    carriers: ['progressiveAuto'],
    reason: 'Business use (e.g. sales, real estate, agent) â€“ acceptable per Progressive; may be surcharged.',
  },
  {
    when: (i) => i.vehicleType === 'sports_or_perf',
    carriers: ['erieAuto'],
    weight: -0.2,
    reason: 'Sports / performance vehicle â€“ may require positive factors for Erie.',
  },
  {
    when: (i) => i.age > 0 && i.age < 22,
    carriers: ['progressiveAuto'],
    weight: 0.2,
    reason: 'Youthful driver â€“ Progressive often competitive here.',
  },
  {
    when: (i) => i.age > 0 && i.age < 22,
    carriers: ['erieAuto'],
    weight: -0.2,
    reason: 'Youthful driver â€“ Erie prefers cleaner profiles.',
  },
  {
    when: (i) => i.age > 0 && i.age < 22,
    carriers: ['wisconsinMutualAuto', 'foremostAuto', 'libertyAuto', 'donegalAuto', 'grinnellAuto', 'dairylandAuto'],
    weight: -0.1,
    reason: 'Youthful driver â€“ most carriers less competitive.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
    carriers: ['progressiveAuto'],
    weight: 0.2,
    reason: 'Multiple claims â€“ Progressive more tolerant of nonâ€‘standard auto.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
    carriers: ['erieAuto'],
  ...
  },
  {
    ...
    weight: 0.5,
    reason: 'High-risk profile â€“ Foremost is best for non-standard auto.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
    carriers: ['dairylandAuto'],
    weight: 0.6,
    reason: "Very high-risk â€“ Dairyland is agency's best option for difficult auto.",
  },
  {
    when: (i) => {
      const highRisk =
    ...
    carriers: ['foremostAuto'],
    weight: 0.4,
    reason: 'Non-standard factors â€“ Foremost competitive for high-risk auto.',
  },
  {
    when: (i) => {
      return (
    ...
    weight: 0.5,
    reason:
      'Very high-risk combo â€“ Dairyland is best option when others decline or are uncompetitive.',
  },
];
...
const HOME_NON_OWNER_OCCUPANCY = {
...
const HOME_DOG_RESTRICTED = {
  erieHome: 'Restricted dog breed or prior bite history â€“ not eligible under Erie guidelines.',
  progressiveHome:
    'Restricted dog breed or prior bite history â€“ not eligible under Progressive HO3 guidelines.',
  travellersHome:
...
const HOME_HAZARD_FLAG = {
  erieHome:
    'Hazardous premises exposures (unfenced pool, trampoline, debris, etc.) â€“ not eligible for Erie home.',
  progressiveHome:
    'Hazardous premises exposures / debris â€“ not eligible for Progressive HO3 homeowners.',
  travellersHome:
...
const HOME_INELIGIBILITY_RULES = [
  {
    when: (i) =>
  ...
  },
  {
    ...
    ineligible: true,
    reason:
      'No prior voluntary homeowners coverage â€“ Progressive HO3 requires prior insurance except for first-time buyers.',
  },
  {
  ...
  },
  {
    ...
    ineligible: true,
    reason:
      'Two or more property claims in recent years â€“ outside Progressive HO3 prior loss guidelines.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
...
const HOME_ROOF_RULES = [
  ...
  },
  {
    ...
    ineligible: true,
    reason:
      'Architectural shingle roof â‰¥ 20 years â€“ Erie guidelines require underwriting approval; treat as not eligible here.',
  },
  {
    ...
    ineligible: true,
    reason:
      '3-tab shingle roof â‰¥ 10 years â€“ Erie guidelines require underwriting approval; treat as not eligible here.',
  },
  {
    ...
    ineligible: true,
    reason:
      'Metal / slate / tile roof â‰¥ 50 years â€“ Erie guidelines require underwriting approval; treat as not eligible here.',
  },
  {
    ...
    ineligible: true,
    reason:
      'Flat roof â‰¥ 10 years â€“ Erie guidelines require underwriting approval; treat as not eligible here.',
  },
  {
    when: (i, ctx) => {
      const m = ctx.roofMat || '';
  ...
  },
  {
    ...
    weight: -0.2,
    reason:
      'Roof age 21â€“25 years â€“ near Progressive 25-year age cap; expect closer underwriting review.',
  },
  {
    ...
    ineligible: true,
    reason:
      'Flat roof older than roughly 2010â€“2012 equivalent â€“ outside Progressive HO3 flat roof guidelines.',
  },
  {
    when: (i, ctx) => {
  ...
  },
  {
    ...
    ineligible: true,
    reason:
      'Per Travelers: roofs over 20 years require inspection or UW review â€“ not eligible here; only roofs 20 years or newer (no inspection/review) are eligible.',
  },
  {
...
const HOME_WEIGHT_RULES = [
  {
    when: (i) => i.dwellingValueBand === '>1500k',
    carriers: ['erieHome'],
    reason:
      'Dwelling value over $1.5M â€“ Erie requires underwriting approval prior to binding.',
  },
  {
    when: (i) =>
    ...
    weight: -0.1,
    reason:
      'Coverage A likely over Progressive $750k review threshold â€“ expect underwriting review.',
  },
  {
    when: (i) =>
      i.dwellingValueBand === '1000-1500k' || i.dwellingValueBand === '>1500k',
  ...
  },
  {
    ...
    weight: -0.3,
    reason:
      'Older electrical/plumbing/heating â€“ Erie may require updates or is less competitive.',
  },
  {
    when: (i) => i.oldSystemsFlag,
    carriers: ['progressiveHome'],
    weight: -0.3,
    reason:
      'Older electrical/plumbing/heating â€“ Progressive guidelines require updated major systems.',
  },
  {
    when: (i) => i.oldSystemsFlag,
    carriers: ['travellersHome'],
  ...
  },
  {
    when: (i) => i.priorCarrierYears === '0' && i.firstTimeBuyer === 'yes',
    carriers: ['progressiveHome'],
    reason: 'First-time home buyer â€“ Progressive HO3 allows no prior coverage for new home purchases.',
  },
  {
    when: (i) => i.multiPolicy === 'yes',
    carriers: ['erieHome'],
    weight: 0.3,
    reason: 'Good package opportunity â€“ Erie often strong on auto/home bundle.',
  },
  {
    when: (i) => i.multiPolicy === 'yes' && i.progressiveAuto === 'yes',
    carriers: ['progressiveHome'],
    weight: 0.3,
    reason: 'Progressive auto + HO3 package â€“ stronger appetite for bundled business.',
  },
  {
    when: (i) => i.claimsHistory === 'multiple',
    carriers: ['libertyHome'],
    weight: -0.2,
    reason:
      'Per Safeco Eligibility Guide: more than 1 loss in prior 5 years â€“ refer to underwriting. All losses in prior 5 years are subject to underwriting review.',
  },
  {
    when: (i) => i.claimsHistory === 'one',
    carriers: ['libertyHome'],
  ...
  },
  {
    ...
    weight: 0.5,
    reason: 'High-risk home profile â€“ Foremost is best for non-standard homeowners.',
  },
  {
    when: (i, ctx) => {
      if (!ctx.eligible) return false;
    ...
    weight: 0.6,
    reason:
      'Very high-risk home â€“ Dairyland is best option when other markets decline or are uncompetitive.',
  },
];
...
const COMMERCIAL_WEIGHT_RULES = [
  ...
  },
  {
    ...
    reason: 'Very competitive on commercial â€“ strong option for BOP/small commercial at this agency.',
  },
  {
    when: (i) => Number(i.priorCarrierYears || 0) >= 3 && i.claimsHistory !== 'multiple',
    weight: 0.1,
    reason: 'Stable small commercial risk â€“ most markets comfortable.',
  },
];

const COMMERCIAL_INELIGIBILITY_RULES = [
  {
    when: (i) =>
    ...
    ineligible: true,
    reason:
      'Zero prior insurance with multiple claims â€“ Erie commercial appetite likely limited.',
  },
];
